    ...
    pub fn new() -> Self {
        ...
        match lang.as_str() {
            "eng" => Self {
                ...
                tts_error_fakeyou: "FakeYou's TTS service is no longer available, audio was generated using the Google voice.".to_string(),
                ...
                fakeyou_warning: "\n\nWARNING: FakeYou's TTS service is no longer available, audio generated using Google voice".to_string(),
            ...
            _ => Self {
                ...
                tts_error_fakeyou: "Il servizio TTS di FakeYou non è più disponibile, l'audio è stato generato usando la voce di Google.".to_string(),
                ...
                fakeyou_warning: "\n\nWARNING: Il servizio TTS di FakeYou non è più disponibile, audio generato usando la voce di Google".to_string(),
