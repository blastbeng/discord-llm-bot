        ...
        match lang.as_str() {
            "eng" => Self {
                ...
                help_text: "\n\n*Voice & Audio:*\n\
                    ...
                    /createvoice <name> — attach or quote an MP3/WAV voice note (10-30s speech) to clone a voice\n\
                ...
                vc_usage: "Usage: /createvoice <name> — attach or quote an MP3/WAV voice note (10-30s of speech)".to_string(),
                vc_created: "Voice {} created! Use it with /speak <text> --voice {}".to_string(),
                ...
                vc_sample_invalid: "Could not read the audio — attach or quote an MP3/WAV voice note with 10-30 seconds of clean speech.".to_string(),
            ...
            _ => Self {
                ...
                help_text: "\n\n*Voce & Audio:*\n\
                    ...
                    /createvoice <nome> — allega o cita una nota vocale MP3/WAV (10-30s) per clonare una voce\n\
                ...
                vc_usage: "Uso: /createvoice <nome> — allega oppure cita una nota vocale MP3/WAV (10-30s di voce)".to_string(),
                vc_created: "Voce {} creata! Usala con /speak <testo> --voice {}".to_string(),
                ...
                vc_sample_invalid: "Impossibile leggere l'audio — allega oppure cita una nota vocale MP3/WAV con 10-30 secondi di voce pulita.".to_string(),
